...
public class RelationshipHandler {
     ...
     */
    public void processAllRelationships(CycloneDxImportContext context, Consumer<Integer> progressCallback) {
        try {
     ...
     */
    private void processSinglePackageRelationships(String sourcePackageId, List<Relationship> relationships, CycloneDxImportContext context)  {
        try {
