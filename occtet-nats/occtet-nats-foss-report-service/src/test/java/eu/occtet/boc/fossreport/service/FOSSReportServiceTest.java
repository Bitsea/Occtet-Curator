...
@Transactional
public class FOSSReportServiceTest {

    private static final Logger log = LoggerFactory.getLogger(FOSSReportServiceTest.class);
   ...
   //@Test
    void controlValuesAndGenerateInventoryItemsWithWorkData() throws IOException {
        log.debug("Starting test for generateAndStoreData with FossReportServiceWorkData");
...
//
//        assertAll("inventoryItem",
//                // Software Component
//                () -> assertEquals("Android shared memory implementation", inventoryItem.getSoftwareComponent().getName()),
//                () -> assertEquals("1.0", inventoryItem.getSoftwareComponent().getVersion()),
//                () -> assertEquals("Apache-2.0", inventoryItem.getSoftwareComponent().getLicenses().getFirst().getLicenseType()),
//                () -> assertEquals("CVE-2008-0986 ", inventoryItem.getSoftwareComponent().getCve()),
//                () -> assertEquals("7.0 HIGH ", inventoryItem.getSoftwareComponent().getSeverity()),
//                () -> assertEquals(licenseTextExp, inventoryItem.getSoftwareComponent().getLicenses().getFirst().getLicenseText()),
//                () -> assertEquals("http://source.android.com", inventoryItem.getSoftwareComponent().getDetailsUrl()),
//
//
//                // Inventory item
//                () -> assertEquals("Android shared memory implementation 1.0", inventoryItem.getInventoryName()),
//                () -> assertEquals(
//                        "Copyright (C) 1989, 1991 Free Software Foundation, Inc. 59 Temple Place, Suite 330, Boston, MA 02111-1307 USA",
//                        inventoryItem.getCopyrights().getFirst().getCopyrightText()),
//                () -> assertEquals("External notes text...", inventoryItem.getExternalNotes()),
//                () -> assertEquals(3, inventoryItem.getPriority()),
...
//                () -> assertEquals("Android data chart 2.0", inventoryItem.getParent().getInventoryName()),
//                () -> assertEquals(rootInventoryItem.getId(), inventoryItem.getParent().getParent().getId()),
//                () -> assertEquals("Android data chart", inventoryItem.getParent().getSoftwareComponent().getName()),
//                () -> assertEquals("2.0", inventoryItem.getParent().getSoftwareComponent().getVersion())
//
//        );
    }

    String licenseTextExp = "Apache License\n" +
