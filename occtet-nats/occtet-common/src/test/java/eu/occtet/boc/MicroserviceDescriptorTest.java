...
public class MicroserviceDescriptorTest {
    ...
    public void testMicroserviceDescriptor() throws JsonProcessingException {
        MicroserviceDescriptor md = new MicroserviceDescriptor("name","description","someWorkData",true);
        String result = (new ObjectMapper()).writerFor(MicroserviceDescriptor.class).writeValueAsString(md);
        Assert.assertEquals("{\"type\":\"descriptor\",\"name\":\"name\",\"description\":\"description\",\"version\":\"\",\"acceptableWorkData\":\"someWorkData\",\"usesAI\":true}",result);
    }
