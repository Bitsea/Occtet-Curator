...
public class SpdxHandlerTest {
    ...
    public void testLicenseHandler_ShouldProcessExtractedAndListedLicenses() throws Exception {
        ...
        Assertions.assertTrue(asmusUsage.getEffectiveText().contains("ASMUS License"), "Usage license should contain the extracted title");
        Assertions.assertTrue(asmusUsage.getEffectiveText().contains("This file contains bugs"), "Usage license should contain the extracted body text");
