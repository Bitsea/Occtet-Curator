...
/**
 * Provides a dialog interface for searching and selecting {@link Project} entities to be associated
...
public class AddProjectDialog extends AbstractAddContentDialog<Organization>{
    ...
    public void addContentButton(ClickEvent<Button> event) {
        ...
        List<Project> projects = getSelection();
        if(!projects.isEmpty() && organization != null){
            close(StandardOutcome.SAVE);
        }
    }

    public List<Project> getSelection() {
        return new ArrayList<>(projectDataGrid.getSelectedItems());
    }
